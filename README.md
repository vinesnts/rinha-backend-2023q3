...
#### Projeto desenvolvido para o torneio Rinha de Backend - Edição 2023 Q3

Torneio disponível em: [https://github.com/zanfranceschi/rinha-de-backend-2023-q3/](https://github.com/zanfranceschi/rinha-de-backend-2023-q3/)

Link do projeto: [https://github.com/vinesnts/rinha-backend-2023q3](https://github.com/vinesnts/rinha-backend-2023q3)

## Desenvolvido por:
- Eu mesmo: ([@vinesnts](https://github.com/vinesnts/))
- Meu site: [viniciusalmeida.dev](https://viniciusalmeida.dev)
